...
(function() {
  ...
  var PluginBabelPath = "https://unpkg.com/systemjs-plugin-babel/plugin-babel.js";
  ...
  var PluginBabelCachePath = "https://unpkg.com/systemjs-plugin-babel@0.0.25/plugin-babel.js";
  ...
  SystemJS.config({
    ...
    paths: {
      ...
      "pdfjs-web": baseLocation.href,
      "pdfjs-test": new URL("test", baseLocation).href,
      "pdfjs-lib": new URL("src/pdf", baseLocation).href,
      "core-js": new URL("https://unpkg.com/core-js@3.6.4").href,
      "web-streams-polyfill": new URL(
        "https://unpkg.com/web-streams-polyfill",
        baseLocation
      ).href,
    },
    meta: {
